...
def find_pictures():
    """
    Find the 50 links to the picture on the first page from Hubble's website and find the sky object category
    returns:
        - img_urls: Direct download links to the picture
        - img_categ: Category of the picture (Galaxy, Nebulae, Solar, Cluster, ...)
    """
...
def create_data(img_urls, img_categ):
    """
    Retrieve the pictures from the website and create the data filed that will be used for training
    parameters:
        - img_urls: Direct download links to the picture
        - img_categ: Category of the picture (Galaxy, Nebulae, Solar, Cluster, ...)
    """
